      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {topics.map((topic) => (
          <div
            ...
            className="bg-white aspect-[2/1] shadow-md rounded-xl flex items-center justify-center text-center p-4 cursor-pointer transition-transform hover:scale-105 hover:shadow-lg"
          >
